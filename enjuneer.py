...
st.write("")
st.write("Take, for example this decision matrix to determine which humanities courses to take based on how many $FuChS^{-1}$ (kilofucks*Credit hours per second) you give per class.")
